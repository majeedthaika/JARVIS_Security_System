...
# with open('trained_NN_weights.pickle', 'wb') as f:
#     pickle.dump(finetuned_weights['pretrained, end-to-end'], f, protocol=pickle.HIGHEST_PROTOCOL)
...
# test_net = caffe.Net(style_net(train=False), style_weights_ft, caffe.TEST)
