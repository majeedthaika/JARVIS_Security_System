...
#
#         try:
#             google_api_key='AIzaSyD0l-GqzHvF2pmTw_UjK0u5Vg4M8pf97yI'
#             print "1"
...
# MyButton6 = Button(root, text="mic", command=buttonClick, bd=0, activebackground='#c1bfbf', overrelief='groove', relief='sunken')
